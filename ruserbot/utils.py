...
def load_module(shortname):
    if shortname.startswith("__"):
        ...
        path = Path(f"ruserbot/plugins/{shortname}.py")
        name = "ruserbot.plugins.{}".format(shortname)
...
def remove_plugin(shortname):
    try:
        try:
            ...
            name = f"ruserbot.plugins.{shortname}"
...
def errors_handler(func):
    async def wrapper(errors):
        try:
            ...
            text = "**ruserbot Error report**\n\n"
            link = "[here](https://t.me/gabut_ngabuburit)"
