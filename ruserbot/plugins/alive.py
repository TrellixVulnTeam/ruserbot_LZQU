...
async def amireallyalive(alive):
    ...
    if CAT_IMG:
        ...
        cat_caption += f"**{EMOJI} ⚙️Telethon version :** `{version.__version__}\n`"
        cat_caption += f"**{EMOJI} 🗡️Ruserbot Version :** `{catversion}`\n"
        ...
        await edit_or_reply(
            ...
            f"**{EMOJI} Ruserbot Version :** `{catversion}`\n"
...
async def amireallyalive(alive):
    ...
    reply_to_id = await reply_id(alive)
    cat_caption = f"**Ruserbot is Up and Running**\n"
    cat_caption += f"**  -⚙️Telethon version :** `{version.__version__}\n`"
    cat_caption += f"**  -🗡️Ruserbot Version :** `{catversion}`\n"
    cat_caption += f"**  -🐉Python Version :** `{python_version()}\n`"
    cat_caption += f"**  -🧸Sensei:** {mention}\n"
