...
class Config(object):
    ...
    # set this with required Ruserbot repo link
    UPSTREAM_REPO = os.environ.get(
        "UPSTREAM_REPO", "https://github.com/rimuru07/Ruserbot.git"
    )
    ...
    THUMB_IMAGE = os.environ.get(
        "THUMB_IMAGE", "https://telegra.ph/file/1e066038dd17b142e3e12.jpg"
    )
    # set blacklist_chats where you do not want Ruserbot's features
    UB_BLACK_LIST_CHAT = {
